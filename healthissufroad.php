<?php
	...
	$selectquery = mysql_query("select * from dummy where issue='Health Care'");
?>
	<form method="post">
<?php
	...
	{	
		...
		echo "<td align='center'><a href='healthstatupdatemem.php?comments=$comments' style='text-decoration:none'>click to Answer</a></td>";
