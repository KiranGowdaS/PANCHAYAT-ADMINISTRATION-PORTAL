<?php
	...
	$selectquery = mysql_query("select * from dummy where issue='Street Light Problem'");
?>
	<form method="post">
<?php
	...
	{	
		...
		echo "<td align='center'><a href='streetstatupdatemem.php?comments=$comments' style='text-decoration:none'>click to Answer</a></td>";
