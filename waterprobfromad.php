<?php
	...
	$selectquery = mysql_query("select * from dummy where issue='Water and Sanitation'");
?>
	<form method="post">
<?php
	...
	{	
		...
		echo "<td align='center'><a href='waterstatupdatemem.php?comments=$comments' style='text-decoration:none'>click to Answer</a></td>";
