...
<div><label style="width:150px; float:left;" class="bodytext">Status : <span class="pinktext">*</span></label></div><div><input name="status" id="email" size="35" type="text"><select name="status">
<option> --- </option>
