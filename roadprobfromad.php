<?php
	...
	$selectquery = mysql_query("select * from dummy where issue='Roads and Transportation'");
?>
	<form method="post">
<?php
	...
	{	
		...
		echo "<td align='center'><a href='roadstransportstatupdatemem.php?comments=$comments' style='text-decoration:none'>click to Answer</a></td>";
